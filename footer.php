                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6 pb-sm-55 pb-xs-55">
                                    <div class="li-shipping-inner-box">
                                        ...
                                        <div class="shipping-text">
                                            <h2>Güvenli ödeme</h2>
                                            <p>Güvenli bir şekilde alışverişinizi tamamlayın</p>
                                        </div>
                                    </div>
                                </div>
                                <!-- Li's Shipping Inner Box Area End Here -->
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-md-6">
                                    ...
                                    <ul class="des">
                                        ...
                                        <li>
                                            <span>Email: </span>
                                            <a href="mailto://<?php echo $ayarCek['email']?>">
                                ...
                                <div class="col-lg-2 col-md-3 col-sm-6">
                                    <div class="footer-block">
                                        ...
                                        <ul>
                                                                                         <?php  
                  $kategori=$baglanti->prepare("SELECT * FROM kategori where  kategori_durum=:kategori_durum and  kategori_sira  limit 8");
...
<script type="text/javascript"> (function () { var options = {
 whatsapp: "+905314957131",
 call_to_action: "Whatsapp hattımız",
 position: "left",
 }; 
var proto = document.location.protocol, host = "whatshelp.io", url = proto + "//static." + host; 
var s = document.createElement('script'); s.type = 'text/javascript'; s.async = true; s.src = 
    url + '/widget-send-button/js/init.js'; 
s.onload = function () { WhWidgetSendButton.init(host, proto, options); }; var x = document.getElementsByTagName('script')[0]; x.parentNode.insertBefore(s, x); })(); </script>
