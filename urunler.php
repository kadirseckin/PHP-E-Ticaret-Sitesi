                                ...
                                <div class="product-select-box">
                                    <div class="product-short">
                                        ...
                                        <select class="nice-select">
                                            ...
                                            <option value="rating">Düşük fiyata göre(Artan)</option>
                                            <option value="date">Yüksek fiyata göre(Azalan)</option>
                                                    ...
                                                    <div class="single-product-wrap">
                                                        <div class="product-image">
                                                            <a href="urun-detay-<?=seolink($urunlerCek['urun_baslik']).'-'.$urunlerCek['urun_id'] ?>">
                                                                <img style="height: 220px;" src="admin/resimler/urunler/<?php echo $urunlerCek['urun_resim'] ?>" alt="Li's Product Image">
                                                            </a>
                                                        ...
                                                        <div class="product_desc">
                                                            <div class="product_desc_info">
                                                                ...
                                                                <h4><a class="product_name" href="urun-detay-<?=seolink($urunlerCek['urun_baslik']).'-'.$urunlerCek['urun_id'] ?>"><?php 
                                                                    echo $urunlerCek['urun_baslik']
                                                                 ?></a></h4>
                                                                <div class="price-box">
                                                                    <span class="new-price"><?php 
                                                                    echo $urunlerCek['urun_fiyat']." ₺";
                                                                 ?></span>
                                                                </div>
                                                            </div>
